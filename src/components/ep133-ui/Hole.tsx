  ...
  return (
    <div className='group/hole'>
      ...
      <div className={classNames(
        'w-full h-full absolute shadow-[1px_1px_0.5px_rgba(255,255,255,calc(0.8*var(--light-intensity)))] transition-all',
        !fullShadow && 'opacity-0 group-active/hole:opacity-100',
